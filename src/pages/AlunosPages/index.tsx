...
const FormWrapper = ({ ErrorMessage, setFieldValue }: DataProps) => {
    return (
        <>
            <div className='row'>
                <div className='mb-3'>
                ...
                <div className="grid md:grid-cols-3 gap-4">
                    ...
                    <div className='mb-3'>
                        <Label>Gênero</Label>
                        <select onChange={e => setFieldValue('genero', e.target.value)} id="genero" name="genero" className="h-11 w-full rounded-lg border appearance-none px-4 py-2.5 text-sm shadow-theme-xs placeholder:text-gray-400 focus:outline-hidden focus:ring-3  dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30">
